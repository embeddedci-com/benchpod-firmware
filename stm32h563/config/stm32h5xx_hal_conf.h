...
/* (not in the plain CMSIS template hal_conf; required by hal_eth.c + ethernetif.c) */
...
#define ETH_MAC_ADDR0    ((uint8_t)0x02)   /* locally-administered MAC */
#define ETH_MAC_ADDR1    ((uint8_t)0x00)
#define ETH_MAC_ADDR2    ((uint8_t)0x00)
#define ETH_MAC_ADDR3    ((uint8_t)0x42)
